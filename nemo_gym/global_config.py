...
EPISODE_PROCESSOR_ROUTES_KEY_NAME = "episode_processor_routes"
EPISODE_ROUTING_MODE_KEY_NAME = "episode_routing_mode"
...
NEMO_GYM_RESERVED_TOP_LEVEL_KEYS = [
    ...
    EPISODE_PROCESSOR_ROUTES_KEY_NAME,
    EPISODE_ROUTING_MODE_KEY_NAME,
    TASKSETS_KEY_NAME,
]
